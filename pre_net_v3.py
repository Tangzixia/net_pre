...
width=299
channel=3
checkpoint_dir="H:/inception_v3.ckpt"
...
if __name__=="__main__":
    with slim.arg_scope(nets.inception.inception_v3_arg_scope()):
        logits_,_=nets.inception.inception_v3(X,reuse=None)
    ...
    init_fn=slim.assign_from_checkpoint_fn(checkpoint_dir,slim.get_model_variables("InceptionV3"),ignore_missing_vars=True)
