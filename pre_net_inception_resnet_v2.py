...
width=299
channel=3
checkpoint_dir="H:/inception_resnet_v2.ckpt"
...
if __name__=="__main__":
    ...
    init_fn=slim.assign_from_checkpoint_fn(checkpoint_dir,slim.get_model_variables("InceptionResnetV2"),ignore_missing_vars=True)
